...
public class Poligono {
    ...
    static float[] coordenadasPoligono = {
            0.0f, 0.0f, 0.0f, //Medio
            0.0f, 1.0f, 0.0f, //Arriba - Medio
            -0.5f, 0.5f, 0.0f, //Arribita - Izquierda
            -0.5f, -0.5f, 0.0f, //Abajito - Izquierda
            0.0f, -1.0f, 0.0f, //Abajo - Medio
            0.5f, -0.5f, 0.0f, //Abajito - Derecha
            0.5f, 0.5f, 0.0f, //Arribita - Derecha
    };

    private short drawOrder[] = { 0, 1, 2, 3, 4, 5, 6, 1}; //El órden en el que va a dibujar de vértice a vértice
    ...
    public Poligono() {
        ByteBuffer byteBuffer = ByteBuffer.allocateDirect(coordenadasPoligono.length * 4);
        byteBuffer.order(ByteOrder.nativeOrder());
        vertexBuffer = byteBuffer.asFloatBuffer();
        vertexBuffer.put(coordenadasPoligono);
